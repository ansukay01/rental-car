...
export default function MaverickRBeneathSlideShowScreen({navigation}) {
  ...
  return (
    ...
    <Swiper style={styles.wrapper}>
      <View style={styles.slide}>
        <Image source={{uri: 'https://orchardcityrv.com/wp-content/uploads/2018/12/FullSizeRender-1024x768.jpeg'}} style={styles.image} />
      </View>
      <View style={styles.slide}>
        <Image source={{uri: 'https://www.bertsmegamall.com/fckimages/pages/2019-can-am-maverick-x3-max-xrs-turbo-r-bmm-expedition/1.jpg'}} style={styles.image} />
      </View>
    </Swiper>
