...
export default function BMW8SeriesBeneathSlideShowScreen({navigation}) {
  ...
  return (
    ...
    <Swiper style={styles.wrapper}>
      ...
      <View style={styles.slide}>
        <Image source={{uri: 'https://img.indianautosblog.com/2018/06/2018-BMW-8-Series-Coupe-interior-dashboard.jpg'}} style={styles.image} />
      </View>
