...
export default function MaverickTrailBeneathSlideShowScreen({navigation}) {
  ...
  return (
    ...
    <Swiper style={styles.wrapper}>
      <View style={styles.slide}>
        <Image source={{uri: 'https://utvactionmag.com/wp-content/uploads/2018/08/CANAM8_DSC_2261.jpg'}} style={styles.image} />
      </View>
      <View style={styles.slide}>
